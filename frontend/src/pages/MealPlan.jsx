...
const SortIcon = () => (
  <svg viewBox="0 0 24 24" width="18" height="18"><path fill="currentColor" d="M3 7h12v2H3V7zm0 10h8v-2H3v2zm0-6h16v-2H3v2z"/></svg>
);
const LightningIcon = () => (
  <svg viewBox="0 0 24 24" width="18" height="18"><path fill="currentColor" d="M13 2 3 14h7l-1 8 10-12h-7l1-8z"/></svg>
);
const ScaleIcon = () => (
  <svg viewBox="0 0 24 24" width="18" height="18"><path fill="currentColor" d="M12 3a9 9 0 1 1 0 18 9 9 0 0 1 0-18zm0 2a7 7 0 1 0 0 14 7 7 0 0 0 0-14zm-1 3h2v5h4v2h-6V8z"/></svg>
);
const FilterIcon = () => (
  <svg viewBox="0 0 24 24" width="18" height="18"><path fill="currentColor" d="M3 5h18v2l-7 7v5l-4 2v-7L3 7V5z"/></svg>
);
...
const foods = {
  ...
  wednesday: [
    ...
    },
    {
      ...
      f: 20,
      img:
        "https://images.unsplash.com/photo-1544025163-2509f02c57d9?q=80&w=800&auto=format&fit=crop",
    },
  ],
  thursday: [
    {
    ...
    },
    {
      ...
      f: 8,
      img:
        "https://images.unsplash.com/photo-1544025162-8a1f9f65b3d3?q=80&w=800&auto=format&fit=crop",
    },
    {
      title: "Shrimp Tacos",
      meal: "Dinner",
  ...
  friday: [
    ...
    {
      title: "Margherita Pizza (Thin Crust)",
      meal: "Dinner",
      cals: 630,
      p: 24,
      c: 78,
  ...
  saturday: [
    ...
    },
    {
      ...
      f: 12,
      img:
        "https://images.unsplash.com/photo-1514511547113-bff19f1f0b38?q=80&w=800&auto=format&fit=crop",
    },
    {
      ...
      f: 26,
      img:
        "https://images.unsplash.com/photo-1605470208304-4562d18e84a5?q=80&w=800&auto=format&fit=crop",
    },
  ],
  sunday: [
    {
      ...
      f: 6,
      img:
        "https://images.unsplash.com/photo-1572441710534-780c9f25926d?q=80&w=800&auto=format&fit=crop",
    },
    {
      title: "Veggie Pasta",
      meal: "Lunch",
